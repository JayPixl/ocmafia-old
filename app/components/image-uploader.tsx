...
export const ImageUploader = ({ onChange, imageUrl, loading, type, maxSize = 2 }: props) => {
    ...
    return (
        <>
            ...
            >
                ...
                {!loading && <input type="file" ref={fileInputRef} onChange={handleChange} className="hidden" accept="image/*" />}
            </div>
